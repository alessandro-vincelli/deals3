...
<!-- CVS $Id: exception2html.xslt 356966 2005-12-15 01:39:29Z crossley $ -->
  ...
  <xsl:template match="ex:exception-report">
    <html>
      <head>
        ...
        <link rel="stylesheet" href="/deals/resource/external/styles/main-cocoon.css" type="text/css" media="screen" />
        ...
        <script src="/deals/resource/external/js/main-cocoon.js" type="text/javascript"/>
      </head>
      <body>
