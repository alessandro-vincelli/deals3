...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="head">
    <head>
      ...
      <link rel="stylesheet" href="/deals/resource/external/styles/deals.css" type="text/css" media="screen"/>
      <link rel="stylesheet" href="/deals/resource/external/styles/lightbox.css" type="text/css" media="screen" />
